%==============================================================================
% Exclude: **/archive/**/*, cmnat.bst
% Fix Cite/Ref
% Find 1: (^(?!%).+)(\\cite\{.*\})
% Replace 1: $1\\iffalse $2 \\fi 
% Find 2: (^(?!%).+)(\\ref\{.*\})
% Replace 2: $1\\iffalse $2 \\fi 
% Find 3: \\iffalse(.*)\s\\fi\s
% Replace 3: $1
%==============================================================================
...
\include{chapters/7_project_team_work}

\include{chapters/8_m2go_contributions}

\include{chapters/9_summary_outlook}
