...
\todo{Section: Why should a k8s cluster be used}
...
\todo{This looks horrible and needs some explanation}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{figures/use_case_monitoring_system.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{figures/use_case_user.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{figures/use_case_developer.png}
