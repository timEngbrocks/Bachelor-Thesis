...
% TODO: review saad
% Stefan würde das relativ gut verstehen. Aber der Rest safe nicht. 
% Immer einen nicht technischen teil hinzufügt,  der grob beschreibt, 
% was gleich erlkärt wird mit stark technischen detail

% TODO: review saad
% In der Section hast du schon eine starke hierarchische struktur. Gerade im Dritten COnfiguring schritt. Da gibts mehrere sachen wo du jedes mal wieder mit first/second/third anfängst. 
% Wäre safe angenehmer, wenn man das bisschen besser einordnen kann oder einen art "inhaltsverzeichnnis" der schritte/unterschritte sieht
% 1. Auto Discovery
% 2. Config Storage Endpoint
% 3. RBAC-based permissions
% ich würde diese tasks erst so kurz erwähnen und dass diese in folgenden erklärt werden. 
% und dann nach jedem punkt einen abschnitt machen (enter). Gerade weil der schritt 3 dann auch noch ewig lang ist und nochmal aus 2 teilen besteht. Sonst wird das ein big cluster of text
% und abeck hat dann roten pfaden 

% TODO: review saad
% hier genauso, erst aufzählen dass es zwei scrape configs gibt, hast ja sogar namen udn dann auf die eingehen

% TODO: review saad
% perfekte intro, so meine ich das in den kommentaren davor 
% -> meint config grafana erste sätze
